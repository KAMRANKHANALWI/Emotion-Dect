...
def main(): 
    ...
    if choice == "Classifier":
        ...
        st.write("In the digital realm where communication often lacks the depth of face-to-face interactions, Emosence emerges as a powerful tool to decode the emotional nuances within written expressions. This innovative app harnesses the synergy of natural language processing and machine learning, placing the ability to understand and interpret emotions right at your fingertips.")
        st.divider()
